        ...
        <div className="p-8 rounded-xl bg-transparent flex items-center justify-center">
          <div className="flex flex-col items-center space-y-4 justify-center">
            <div className="relative w-14 h-14">
              <motion.div
                className="absolute inset-0 border-4 border-blue-600 border-opacity-30 rounded-full"
                ...
                <form onSubmit={handleProfileUpdate} className="space-y-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="shadow-sm bg-gray-50 focus:bg-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border border-gray-300 rounded-lg p-3 transition duration-150"
                  ...
                  <div className="pt-5">
                    <div className="flex justify-end">
                      <motion.button
                        ...
                        whileTap={{ scale: 0.98 }}
                        className={`inline-flex justify-center py-3 px-6 border border-transparent shadow-sm text-sm font-medium rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 ${
                          updating
                            ? "bg-blue-400"
