...
export default function PrivacyPolicy() {
  return (
    <>
    <div className="bg-gradient-to-b from-white to-blue-50 min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      <motion.div 
      ...
      >
        <div className="bg-blue-600 px-8 py-6">
          ...
          <p className="text-blue-100 mt-2">Last Updated: February 27, 2025</p>
        </div>
        ...
        <div className="p-8 space-y-8">
          <section>
            ...
            <p className="text-gray-600">
              Welcome to CoDocs (&quot;we&quot;, &quot;our&quot;, or &quot;us&quot;). We respect your privacy and are committed to protecting your personal data. 
              This Privacy Policy explains how we collect, use, and safeguard your information when you use our CoDocs application.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="mb-6">
              <h3 className="text-xl font-medium text-blue-700 mb-2">Personal Information</h3>
            ...
            <div className="mb-6">
              <h3 className="text-xl font-medium text-blue-700 mb-2">Content Information</h3>
              <ul className="list-disc pl-6 text-gray-600 space-y-1">
            ...
            <div>
              <h3 className="text-xl font-medium text-blue-700 mb-2">Technical Information</h3>
              <ul className="list-disc pl-6 text-gray-600 space-y-1">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 text-gray-600 space-y-1">
              <li>Provide and maintain the CoDocs service</li>
          ...
          <section>
            ...
            <p className="text-gray-600">
              CoDocs is not intended for children under 13. We do not knowingly collect information from children under 13.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-600">
              By using CoDocs, you consent to our Privacy Policy and agree to its terms.
            </p>
          </section>
        </div>
      </motion.div>
