...
type Note = {
  ...
  title: string;
  content: string;
  doc_id: string; // Assuming doc_id is used for navigation
  created_at: string;
};
    ...
    const { error } = await supabase.from('notes').insert([
      {
        doc_id: docId,
        user_id: user.id,
        title: 'Untitled', // or default content
        content: '',
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <motion.button
            ...
            className={`mt-4 md:mt-0 ${
              isFormOpen ? 'bg-gray-600 hover:bg-gray-700' : 'bg-blue-600 hover:shadow-lg'
        ...
        {isLoading ? (
          ...
          <NotesList notes={notes} onEdit={startEditing} onDelete={handleDeleteNote} />
        )}
        <SharedNotesList />
      </div>
    </div>
