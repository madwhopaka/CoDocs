            ...
            >
                <div className="flex flex-col items-center">
                    ...
                    <motion.div
                        ...
                        className="bg-blue-600 w-14 h-14 rounded-xl shadow-md flex items-center justify-center"
                    >
                ...
                <form className="mt-8 space-y-6" onSubmit={handleSignIn}>
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            <div className="flex justify-between items-center mb-1">
                                ...
                                <Link href="/reset-password" className="text-xs text-blue-400 hover:text-blue-500">
                    ...
                    <div>
                        <motion.button
                            ...
                            type="submit"
                            disabled={loading}
                            className="group relative w-full flex justify-center py-3 px-4 border border-transparent text-sm font-medium rounded-lg text-white bg-blue-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 shadow-sm transition-all duration-200 disabled:opacity-70"
                        >
                            {loading ? (
